...
// GET /api/z-api/qr-code - Obter QR Code da instância Z-API
export async function GET(request: NextRequest) {
  try {
    ...
    // Obter QR Code
    const result = await zApiClient.getQrCode()
    ...
    console.error('Erro no endpoint GET /api/z-api/qr-code:', error)
    return NextResponse.json(
